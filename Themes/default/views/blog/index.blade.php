...
@section('title', app_name() . ' | '. __('t.blog'))
...
@section('content')
    ...
    @include('includes._title_header', ['title' => __('t.blog')])
    ...
    <section class="pt-5 bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div id="course-list" class="row" style="display:none;">
                        @if($posts->count())
                            <div class="row">
                                @each('blog.partials._post', $posts, 'post')
                            </div>
                        @else 
                            <p>{{ __('t.no-posts-yet') }}</p>
                        @endif
                        <hr>
                    </div>
