                        ...
                        <ol class="dd-list">
                            ...
                            @foreach($v->subCategories as $sub)
                              ...
                              <li class="dd-item dd3-item" data-id="{{ $sub->id }}">
                                    <div class="dd-handle dd3-handle">Drag</div>
                                    <div class="dd3-content">
                                        {{ $sub->id }}->{{ $sub->name }} <span class="badge badge-secondary">{{$sub->courses->count()}}</span> 
                                        <span class="pull-right">
                               ...
                               @foreach($sub->subCategories as $sub1)
                                ...
                                <li class="dd-item clearfix" data-id="{{ $sub1->id }}">
                                    <div class="dd-handle dd3-handle">Drag</div>
                                    <div class="dd3-content">
                                        {{ $sub1->id }}->{{ $sub1->name }} <span class="badge badge-secondary">{{$sub1->courses->count()}}</span> 
                                        <span class="pull-right">
...
@section('modals')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                           {!! Form::label("parent_category", __('t.parent-category')) !!}
                            {!! Form::select("parent_category", $parentCategories, null, ['class'=>'form-control','id'=>'parentCategoryID']) !!}
    ...
    <script>
        $(document).ready(function($){
            ...
            $('#parentCategoryID ').click(function(e){
              console.log($('#parentCategoryID option:selected').attr('value'));
