                    ...
                    <nav class="wsmenu clearfix">
                        <ul class="mobile-sub wsmenu-list">
                            ...
                            <ul class="wsmenu-submenu">
                                ...
                                <a href="{{ route('frontend.courses', ['class' => $c->slug] ) }}">
                                ...
                                <ul class="wsmenu-submenu-sub">
                                    ...
                                    <a href="{{ route('frontend.courses', ['class' => $c->slug,'board'=>$sc->slug] ) }}">
                                        {{ $sc->name }}
                                    </a>
                                    ...
                                    <ul class="wsmenu-submenu-sub-sub">
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.courses', ['class' => $c->slug,'board'=>$sc->slug,'subject'=>$sc1->slug] ) }}">
                                                {{ $sc1->name }}
                                            </a>
