...
class CourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->class && $request->board) {
            
            $filters['class'] = $request->class;
            $filters['board'] = $request->board;
            // now to fetch the subCategories 
            // return $request;
            
        }
        if ($request->class && $request->board && $request->subject) {
            
            $filters['class'] = $request->class;
            $filters['board'] = $request->board;
            $filters['subject'] = $request->subject;
            // now to fetch the ChildCategories
            $subject = $request->subject;
            $courses = Course::where(['approved' => true, 'published' => true])->with('subject')
