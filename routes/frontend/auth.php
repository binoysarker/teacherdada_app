...
Route::group(['namespace' => 'Auth', 'middleware'=>'theme', 'as' => 'auth.'], function () {
    ...
    */
    ...
    Route::group(['middleware' => ['guest']], function () {
        ...
        if (config('access.registration')) {
            ...
            Route::get('register-teacher', 'RegisterController@showRegistrationFormforteacher')->name('register-teacher');
            Route::post('register', 'RegisterController@register')->name('register.post');
            Route::post('register_as_teacher', 'RegisterController@register_as_teacher')->name('register_as_teacher.post');
        }
