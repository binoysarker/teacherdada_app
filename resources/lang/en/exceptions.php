    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'created_pending_under_admin'   => 'Your account was successfully created and is pending approval. An e-mail will be sent when your account is approved. you are under admin review please contact to admin.',
                'created_pending_via_admin' => 'Your approval from admin is pending, you will be notified via email once your account is approved. you can create your courses after approval.',
